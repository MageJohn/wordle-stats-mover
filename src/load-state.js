...
div.setAttribute(
  "style",
  "position:absolute;top:0;right:0;bottom:0;left:0;z-index:10000;background:white;"
);
...
var btnClick =
  "var str = window.document.getElementById('gameStateInput').value;" +
  "try{" +
  "var json = JSON.parse(atob(str));" +
  "if (json.gameState == null || json.statistics == null) throw 'err';" +
  "window.localStorage.setItem('" +
  stateKey +
  "', JSON.stringify(json.gameState));" +
  "window.localStorage.setItem('" +
  statsKey +
...
div.innerHTML =
  '<textarea id="gameStateInput" style="width:100%;height:150px;box-sizing:border-box;" placeholder="Paste your save here"></textarea><button onclick="' +
  btnClick +
  '">Restore</button>';
